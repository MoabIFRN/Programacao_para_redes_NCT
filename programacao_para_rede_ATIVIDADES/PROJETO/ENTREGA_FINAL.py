...
TOKEN = '6952533718:AAH5ya3iAzqP3OnEXL1lAu-5TF90_fRlM_I'
...
def opcoes_command(message):
    texto = """
    Olá! Seja bem-vindo ao bot Cronos. Estou aqui para te ajudar com várias funcionalidades interessantes. Vamos dar uma olhada nelas:
    /clima - Quer saber como está o tempo?
    /dolar - Cotação do dólar em relação ao Real (R$).
    /filme - Para os amantes do cinema, temos a funcionalidade que fornece informações sobre os filmes atualmente em cartaz.
    /mensagem - E para começar o dia com inspiração, deseja receber uma mensagem do dia ?"""
